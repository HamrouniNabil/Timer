...
class Timer extends React.Component{
    ...
    constructor(props){
        ...
        setInterval(
            ...
            this.setState({
                runningTime: this.state.runningTime + 0.004
            })
            this.sToHMS(this.state.runningTime)
        } 
        },
            1
            )
    ...
    sToHMS = ( s ) => {
        ...
        seconds: parseInt((s - (this.state.hours * 3600) - (this.state.minutes * 60)) / 1)
        })
    }
    ...
    return (<div >
                ...
                <div>
                    <button  onClick={this.Click}>{this.state.status ? 'Stop' : 'Start'}</button>
